...
## Создать новый опрос
#### Метод: POST
#### Необходим токен в заголовке (Authorization: Token ваш токен)
...
+ respondent - id пользователя. По умолчанию пользователь проходит опросы анонимно. Если нужно привязать ответ к пользователю, необходимо создать пользователя и передать id.
